# Script semplice per caricare il contesto Tsunami
...
"Generato il $(Get-Date -Format 'dd/MM/yyyy HH:mm:ss')" | Out-File -FilePath $outputFile -Append -Encoding UTF8
...
Write-Host "Trascina questo file nella chat di Trae!" -ForegroundColor Yellow
